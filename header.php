...
<header class="sticky top-0 z-40 bg-white">
    <!-- Top bar -->
    <div class="max-w-[1200px] mx-auto px-4 flex items-center justify-between py-[15px] lg:pt-5 lg:pb-5">
        <!-- Logo -->
        ...
        <div class="flex items-center gap-[15px] lg:gap-5">
            <!-- Search -->
            <button type="button" class="shrink-0 text-[#353535] hover:text-[#004f86] transition-colors" aria-label="<?php esc_attr_e('Search', 'csie'); ?>">
            ...
            <button
                id="csie-menu-toggle"
                type="button"
                class="lg:hidden bg-[#004f86] text-white text-sm leading-[1.2] px-[15px] h-[35px] rounded-full flex items-center"
    ...
    <?php if (has_nav_menu('secondary')) : ?>
        <nav class="hidden lg:block bg-[#004f86] w-full">
            <div class="max-w-[1200px] mx-auto px-[200px] py-[15px] flex items-center justify-between">
                <?php
                wp_nav_menu([
    ...
    <div id="csie-mobile-menu" class="hidden lg:hidden border-t border-[rgba(0,79,134,0.05)] bg-white">
        ...
        <?php if (has_nav_menu('secondary')) : ?>
            <nav class="px-4 py-4 space-y-3 border-t border-[rgba(0,79,134,0.1)]">
                <?php
                wp_nav_menu([
                    'theme_location' => 'secondary',
                    'container'      => false,
