...
<header class="sticky top-0 z-40 bg-white">
    <!-- Top bar -->
    <div class="max-w-[1200px] mx-auto px-4 flex items-center justify-between py-[15px] md:px-[15px] lg:pt-5 lg:pb-5">
        <!-- Logo -->
    ...
    <?php if (has_nav_menu('secondary')) : ?>
        <nav class="hidden lg:block bg-[#004f86] w-full">
            <div class="max-w-[1200px] mx-auto py-[15px] md:px-[15px] flex items-center justify-between">
                <?php
                wp_nav_menu([
