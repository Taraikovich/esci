...
<main id="content" class="relative overflow-hidden">
    ...
    <div class="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-20 lg:pt-10 lg:pb-10">
        <!-- Gradient Title -->
        <h1 class="text-[28px] lg:text-[50px] font-bold uppercase leading-[1.2] text-center lg:text-left mb-8 lg:mb-12 bg-gradient-to-r from-[#df4253] to-[#004f86] to-[65%] bg-clip-text text-transparent">
