...
<section class="relative bg-white py-[60px] lg:py-[100px] after:absolute after:bottom-0 after:left-0 after:w-full after:h-[290px] after:bg-[#004f86]">
    <div class="max-w-[1200px] mx-auto px-[15px] xl:px-0 overflow-hidden lg:overflow-visible">
            ...
            <div class="flex flex-col gap-[15px] lg:max-w-[430px]">
                <div class="flex items-center justify-between gap-[10px]">
                    <h2 class="text-[25px] lg:text-[40px] font-bold uppercase leading-[1.2] text-[#353535]">
                        <?php esc_html_e('Automation', 'csie'); ?>
                    </h2>
                ...
                <p class="text-[14px] lg:text-base leading-[1.2] text-[#606060] max-w-[264px] lg:max-w-none">
                    <?php esc_html_e('Industrial Automation technologies and their implementation is one of key directions in our business', 'csie'); ?>
                </p>
            </div>

            <!-- Button (desktop only) -->
            <a href="#" class="hidden lg:flex items-center justify-between gap-4 bg-[#004f86] text-white rounded-full px-8 h-[50px] w-[220px] text-base font-medium leading-[1.2] hover:bg-[#00b1ff] transition-colors shrink-0">
        ...
        <?php
        $csie_automation_cards = array(
            array(
                'title' => __('Experience', 'csie'),
                'text'  => __('Educated staff. Every employee in our industrial automation department has at least M.Sc. degree in industrial automation, computer science, or applied mathematics. Project leading is provided by Univ.-Professor and 3 Ph.D. specialists', 'csie'),
            ),
            array(
                'title' => __('Uniqueness', 'csie'),
                'text'  => __('Educated staff. Every employee in our industrial automation department has at least M.Sc. degree in industrial automation, computer science, or applied mathematics. Project leading is provided by Univ.-Professor and 3 Ph.D. specialists', 'csie'),
            ),
            array(
                'title' => __('Products & Solutions', 'csie'),
                'text'  => __('Our dedication to engineering excellence has resulted in very flexible and adaptable products and solutions on the market for custom applications today', 'csie'),
            ),
            array(
                'title' => __('Research', 'csie'),
                'text'  => __('Belarusian State University of Informatics and Radioelectronics, Minsk, Belarus Technical University Ilmenau, Ilmenau, Germany Bialystok Technical University, Bialystok, Poland', 'csie'),
            ),
        );
        ?>
        <div class="swiper csie-automation" style="overflow: visible;">
            <div class="swiper-wrapper">
                <?php foreach ($csie_automation_cards as $csie_index => $csie_card) : ?>
                    <div class="swiper-slide">
                        <div class="drop-shadow-[0_0_2px_rgba(0,0,0,0.3)]">
                            <div class="tag min-h-[340px] <?php echo 0 === $csie_index % 2 ? 'bg-[#FFF]' : 'bg-[#F8F8F8]'; ?> pt-20 px-10 pb-10"
                                ...
                                <h4 class="text-[24px] font-bold uppercase leading-[1.2] text-[#353535] mb-[20px]"><?php echo esc_html($csie_card['title']); ?></h4>
                                <p class="text-base leading-[1.2] text-[#606060]"><?php echo esc_html($csie_card['text']); ?></p>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
