...
/**
 * Uniqueness section for service pages.
 *
 * @package csie
 */

$csie_uniq_title = get_field('uniqueness_title');
...
<section class="py-[50px] lg:py-[100px]">
	<div class="max-w-[1200px] mx-auto px-[15px] xl:px-0">
		...
		<div class="flex flex-col gap-[15px] lg:gap-[20px] mb-[30px] lg:mb-[50px]">
				...
				<div class="flex items-center justify-between">
					<h2 class="font-bold text-[25px] lg:text-[40px] leading-[1.2] uppercase">
						<span class="bg-gradient-to-r from-[#df4253] to-[#004f86] to-[65%] bg-clip-text text-transparent">
							<?php echo esc_html($csie_uniq_title); ?>
						</span>
					</h2>
			...
			<?php if ($csie_uniq_desc) : ?>
				<p class="text-[14px] lg:text-[16px] leading-[1.2] text-[#606060]">
					<?php echo esc_html($csie_uniq_desc); ?>
				</p>
			<?php endif; ?>
		</div>

		<!-- Cards Swiper -->
		<?php if ($csie_uniq_cards) : ?>
