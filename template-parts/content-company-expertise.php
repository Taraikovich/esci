...
/**
 * Key Areas of Expertise section for company page.
 *
 * @package csie
 */

$csie_expertise_title = get_field('expertise_title');
$csie_expertise_cards = get_field('expertise_cards');

if (! $csie_expertise_cards) {
    return;
}
?>
...
<section class="py-[50px] lg:py-[100px]">
    <div class="max-w-[1200px] mx-auto px-[15px] lg:px-0">
        ...
        <?php if ($csie_expertise_title) : ?>
            <div class="flex items-center justify-between mb-[30px] lg:mb-[50px]">
                <h2 class="font-bold text-[25px] lg:text-[40px] leading-[1.2] uppercase text-[#353535]">
                    <?php echo esc_html($csie_expertise_title); ?>
                </h2>
        ...
        <!-- Cards Swiper -->
        <div class="swiper csie-expertise-swiper">
                                ...
                                <?php if ($csie_card['card_image']) : ?>
                                    <div class="relative w-[65px] h-[55px] shrink-0">
                                        ...
                                        <img
                                            ...
                                            class="absolute inset-0 m-auto w-[45px] h-[45px] object-contain transition-transform duration-500 group-hover:scale-120">
                                    </div>
                                <?php endif; ?>
                            </div>
