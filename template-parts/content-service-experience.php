...
<section class="relative py-[30px] lg:py-[50px] before:content-[''] before:block before:absolute before:top-0 before:w-full before:h-[319px] before:bg-[#004f86] overflow-hidden lg:overflow-visible">
