...
<section class="relative py-[30px] lg:py-[50px] bg-white before:content-[''] before:block before:absolute before:top-0 before:w-full before:h-[350px] before:bg-[#004F86]">
    <div class="container relative mx-auto lg:max-w-300 px-3.75 xl:px-0 overflow-hidden">
        <div class="flex items-center justify-between mb-[30px] lg:mb-[50px]">
            <h2 class="font-bold text-[25px] lg:text-[40px] leading-[1.2] uppercase text-white">
                <?php esc_html_e('Technologies', 'csie'); ?>
            </h2>
