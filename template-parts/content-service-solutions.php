...
/**
 * Business Optimization Solutions section for service pages.
 * Based on content-automation.php card style.
 *
 * @package csie
 */

$csie_sol_title = get_field('solutions_title');
						...
						<div class="swiper-slide">
							<div class="group drop-shadow-[0_0_2px_rgba(0,0,0,0.3)]">
								<div class="<?php echo 0 === $csie_index % 2 ? 'bg-[#fff]' : 'bg-[#f8f8f8]'; ?> min-h-[340px] pt-[80px] px-[40px] pb-[30px] flex flex-col justify-between"
									...
									<?php if (!empty($csie_card['card_link'])) : ?>
										<a href="<?php echo esc_url($csie_card['card_link']); ?>" class="flex items-center gap-[10px] text-[#004f86] font-medium text-[16px] leading-[1.2] mt-[20px] lg:opacity-0 lg:group-hover:opacity-100 transition-opacity duration-300">
											<?php esc_html_e('read more', 'csie'); ?>
											<svg width="16" height="10" viewBox="0 0 16 10" fill="none" xmlns="http://www.w3.org/2000/svg">
												<path d="M11 1L15 5M15 5L11 9M15 5H1" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
											</svg>
										</a>
									<?php endif; ?>
								</div>
